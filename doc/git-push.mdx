...
<html lang="en">
  ...
  <body>
    <div class="reveal">
      <div class="slides"><section  data-markdown><script type="text/template">import { Head, Image, Appear } from 'mdx-deck'
import { SplitRight, Split, Horizontal, FullScreenCode } from 'mdx-deck'
...
# Git! Push!
## What is it good for?
# Absolutely *errthang*!</script></section><section  data-markdown><script type="text/template">![Servidor con 38 años](https://farm1.staticflickr.com/3/5119753_0dd1c36628_o_d.jpg)
...
<Appear>
    ...
    <li>Profe en UGR</li>
</Appear></script></section><section  data-markdown><script type="text/template">export default SplitRight

![Push](https://farm2.staticflickr.com/1937/43783892920_78ee9bef50_h_d.jpg)

# `git`</script></section><section  data-markdown><script type="text/template">export default SplitRight
...
```
</script></section><section  data-markdown><script type="text/template">export default SplitRight

![¿Para qué sirve?](https://farm5.staticflickr.com/4810/31993107578_77df74653c_k_d.jpg)

# Para la nube
</script></section><section  data-markdown><script type="text/template">export default Split
...
![Mecanismo del reloj](https://farm2.staticflickr.com/1438/1240116506_ae3ada3a4b_b_d.jpg)</script></section><section  data-markdown><script type="text/template">export default SplitRight

# *Blobs*

![Medusas](https://farm2.staticflickr.com/1888/43736920854_cd8bad7158_k_d.jpg)</script></section><section  data-markdown><script type="text/template">export default Split
...
```</script></section><section  data-markdown><script type="text/template">export default FullScreenCode
...
```
</script></section><section  data-markdown><script type="text/template">### ①②③ Para los ránkings de `@iblancasa`
...
```</script></section><section  data-markdown><script type="text/template">## Por ejemplo: contribuyentes en *Hacktoberfest*
...
.gitignore
```
</script></section><section  data-markdown><script type="text/template"># `.gitignore` para la seguridad
